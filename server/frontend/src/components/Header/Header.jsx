/**
 * React component that renders the navigation bar (header) for the dealership web app
 *
 * Responsibilities:
 * - Display site navigation links: Home, About Us, Contact Us
 * - Show logged-in user information and logout option if a user is authenticated
 * - Handle user logout by clearing session storage and redirecting to the homepage
*/
