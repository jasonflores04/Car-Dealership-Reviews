/*
React component for displaying and filtering cars available at a specific dealer

Responsibilities:
- Fetch dealer details using the dealer ID from URL params
- Fetch all cars associated with the dealer from the backend
- Populate unique lists of car makes and models for filtering
- Filter cars dynamically based on user-selected criteria:
   - Make
   - Model
   - Year
   - Mileage
   - Price
- Allow reset of all filters to show all cars
*/
...
const SearchCars = () => {
  ...
  // Populate unique makes and models for dropdown filters
  ...
  // Apply local filtering based on all selected criteria
  ...
  // Individual backend search functions
  ...
  // Fetch dealer info and cars on component mount
  useEffect(() => {
    fetchCars();
    fetchDealer();
  },[]); 
